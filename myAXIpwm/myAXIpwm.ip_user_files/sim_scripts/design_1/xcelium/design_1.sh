...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../myAXIpwm.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../myAXIpwm.gen/sources_1/bd/design_1/ipshared/5765/hdl" \
       +incdir+"../../../../myAXIpwm.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../myAXIpwm.gen/sources_1/bd/design_1/ipshared/5765/hdl" \
       +incdir+"/nfs/xilinx/Vivado/2022.1/data/xilinx_vip/include"
}
